...
public void setnsb2(){
    String dat=JOptionPane.showInputDialog("Masukan Saldo awal (min Rp 150.000)?");
    saldo_awal=Double.parseDouble(dat);
    saldo_akhir=saldo_awal;
    if (saldo_akhir<150000)
    {JOptionPane.showMessageDialog(null,"Maaf saldo awal min Rp 150.000");}
    else
    {
    saldo_akhir=saldo_awal;}
} 
...
public void setnsb3(){
    {
    String data=JOptionPane.showInputDialog("Masukan jumlah nominal setoran (min Rp 20.000)?");
    setor=Double.parseDouble(data);
    if (setor<20000)
    {JOptionPane.showMessageDialog(null,"Maaf Setoran minimal Rp 20.000");}
    else
    {
